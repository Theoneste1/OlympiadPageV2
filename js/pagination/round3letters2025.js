   ...
   // get the number of the students
    ...
    function createPageList() {
        ...
        for (i = 0; i<length; i++) {
                ...
                var headerCell = document.createElement("td");
                headerCell.innerHTML = data.table.rows[i].c[0].v;
                row.appendChild(headerCell);
                ...
                row.appendChild(headerCell);
                   ...
                   style.classList.remove("remove");
                    ...
                    // school informations
                    document.getElementById("schoolname").innerHTML=data.table.rows[index].c[11].v;
                    document.getElementById("teachername").innerHTML=data.table.rows[index].c[4].v;
                    ...
                    document.getElementById("center").innerHTML=data.table.rows[index].c[12].v
